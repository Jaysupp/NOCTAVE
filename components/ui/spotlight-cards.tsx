...
function Card({ item, dimmed, onHoverStart, onHoverEnd, isLampOn }: CardProps) {
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background: `radial-gradient(ellipse at 20% 20%, ${effectiveColor}14, transparent 65%)`,
                }}
            />
            ...
            <motion.div
                ...
                style={{
                    opacity: glowOpacity,
                    background: `radial-gradient(ellipse at 20% 20%, ${effectiveColor}2e, transparent 65%)`,
                }}
            />
            ...
            <div
                ...
                style={{
                    ...
                    boxShadow: `inset 0 0 0 1px ${effectiveColor}30`,
                }}
            >
                <Icon size={17} strokeWidth={1.9} style={{ color: effectiveColor }} />
            </div>

            {/* Text */}
            <div className="relative z-10 flex flex-col gap-2">
                <h3 className="font-semibold text-[14px] text-zinc-100 tracking-tight">
                    {item.title}
                </h3>
            ...
            <div
                ...
                style={{
                    background: `linear-gradient(to right, ${effectiveColor}80, transparent)`,
                }}
            />
        </motion.div>
    );
    ...
    return (
        <div
            className={cn(
                ...
                "bg-transparent", // adapted to fit cleanly into our backgrounds
                className
            )}
        >
            {/* Header */}
            {(eyebrow || heading) && (
                <div className="relative mb-6 flex flex-col gap-1.5">
                    {eyebrow && (
                        <p className="font-semibold text-[10px] text-zinc-500 uppercase tracking-[0.22em]">
                            {eyebrow}
                        </p>
                    )}
                    {heading && (
                        <h2 className="font-heading font-black text-2xl text-zinc-100 tracking-tight uppercase">
                            {heading}
                        </h2>
                    )}
                </div>
